...
```json
{
  ...
  "faq": {
    ...
    "a1": "Les commandes sont expédiées sous 1 à 2 jours ouvrés. La livraison prend ensuite de 3 à 7 jours ouvrés selon votre localisation.",
    "q2": "Comment taillent les produits ?",
    "a2": "Nos modèles taillent normalement. Consultez le guide des tailles sur chaque fiche produit pour choisir la taille idéale.",
    "q3": "Combien de temps pour effectuer un retour ?",
    "a3": "Vous disposez de 14 jours après réception pour retourner un article non porté, dans son emballage d'origine.",
    "q4": "Comment entretenir les textiles ?",
    "a4": "Nettoyez à la main ou en machine à froid selon les indications de l'étiquette, et laissez sécher à l'air libre.",
    "q5": "Comment vous contacter ?",
    "a5": "Notre équipe est disponible via la page Contact ou par e-mail à contact@divinexpress.fr, du lundi au vendredi."
  },
  "footer": {
...
```json
{
  ...
  "faq": {
    ...
    "a1": "Orders ship within 1-2 business days. Delivery then takes 3-7 business days depending on your location.",
    "q2": "How do the products fit?",
    "a2": "Our items fit true to size. Check the size guide on each product page to pick the right size.",
    "q3": "How long do I have to make a return?",
    "a3": "You have 14 days after receiving your order to return an unworn item in its original packaging.",
    "q4": "How should I care for the fabrics?",
    "a4": "Hand wash or machine wash cold per the label instructions, and air dry.",
    "q5": "How can I contact you?",
    "a5": "Our team is available via the Contact page or by email at contact@divinexpress.fr, Monday to Friday."
  },
  "footer": {
