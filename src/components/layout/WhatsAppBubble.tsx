...
/** Floating WhatsApp bubble shown on storefront pages; opens a WhatsApp chat. */
export function WhatsAppBubble() {
  ...
  return (
    <a
      ...
      aria-label={label}
      className="group fixed bottom-[25vh] right-4 z-50 flex items-center gap-0 rounded-full bg-[#25D366] text-white shadow-lg shadow-black/20 ring-1 ring-black/5 transition-all duration-300 hover:gap-2 hover:pr-4 sm:right-6"
    >
      <span className="relative flex size-14 items-center justify-center">
        <span className="absolute inline-flex size-full animate-ping rounded-full bg-[#25D366] opacity-40 group-hover:hidden" />
